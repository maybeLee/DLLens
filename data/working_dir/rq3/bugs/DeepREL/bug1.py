...
value = 0.5
try:
  results["res_1"] = _input_tensor.addcdiv_(tensor1, tensor2, value=value, )
except Exception as e:
  results["err_1"] = "ERROR:"+str(e)
try:
  results["res_2"] = _input_tensor_tensor.clone().addcmul_(tensor1_tensor.clone(),tensor2_tensor.clone(),value=value,)
except Exception as e:
